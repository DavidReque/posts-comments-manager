...
`http://localhost:3000`. Para la carga masiva (`bulk-posts-example.json`), abre
PowerShell en la raiz del repositorio (la carpeta del clon).
...
```powershell
$bulkJson = Get-Content -Raw ".\bulk-posts-example.json"
